...
import academyAttendanceInsightsRoutes from './routes/academyAttendanceInsights';
import academyParentRoutes from './routes/academyParent';
import academyNotificationsRoutes from './routes/academyNotifications';
...
app.use('/api/academy/attendance-insights', academyAttendanceInsightsRoutes);
app.use('/api/academy/parent',     academyParentRoutes);
app.use('/api/academy/notifications', academyNotificationsRoutes);
